class ReportsController < ApplicationController
  ...
  def new
    @report_content = "<h1>不妊治療へ踏み切ったきっかけ・思い</h1><br><br><br><h1>不妊治療を始めて驚いたこと</h1><br><br><br><h1>夫婦間での治療に対する温度や認識</h1><br><br><br><h1>仕事との両立</h1><br><br><br><h1>治療中気をつけたこと(お酒･食事･睡眠･サプリ他)</h1><br><br><br>"
  ...
  private
    ...
    def report_params
      params.require(:report).permit(
        ...
        :choice_of_sairantime,
        :time_for_sairan,
        :choice_of_ishokutime,
        :time_for_ishoku,
